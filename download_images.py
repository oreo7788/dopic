...
class ImageDownloader:
    ...
    def __init__(self, base_url: str, save_dir: str = './downloaded_images', delay: float = 0.5, verbose: bool = False, create_zip: bool = False):
        """
        初始化下载器
    ...
    def download_all_images(self, image_urls: List[Dict], start_index: int = 1) -> None:
        ...
        # 注意：压缩功能在 fetch_and_download 方法的所有页面下载完成后统一执行
...
示例:
  ...
  python download_images.py https://example.com/gallery -o ./gallery_images -d 1.0 -v
    ...
    parser.add_argument(
        ...
        help='保存目录基础路径（默认: ./downloaded_images）'
    )
